...
namespace Replayer.Core.v04.Annotation
{
    ...
    public class Track : INotifyPropertyChanged
    {
        ...
        public Guid Id
        {
            ...
            set
            {
                if (_id == value) return; //no change? forget about it!
                _id = value;
        ...
        public String Artist
        {
            ...
            set
            {
                if (_artist == value) return; //no change? forget about it!
                _artist = value;
        ...
        public String Name
        {
            ...
            set
            {
                if (_name == value) return; //no change? forget about it!
                _name = value;
        ...
        public String Album
        {
            ...
            set
            {
                if (_album == value) return; //no change? forget about it!
                _album = value;
        ...
        public double Measure
        {
            ...
            set
            {
                if (_measure == value) return; //no change? forget about it!
                _measure = value;
        ...
        public String Url
        {
            ...
            set
            {
                if (_url == value) return; //no change? forget about it!
                _url = value;
