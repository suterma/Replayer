...
namespace Replayer.Model {
    ...
    /// </summary>
    /// <remarks>The implemented type is advertised as the Type. Using this pattern saves the code from implementing a full blown plugin architecture.</remarks>
    public interface ICompilation {
        /// <summary>
        ///     Gets the implemented type of this compilation.
        /// </summary>
        CompilationType Type { get; }
        ...
        /// </summary>
        ICompilation Retrieve(string url);
    }
}