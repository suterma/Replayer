...
namespace Quirli.Api.Test {
    ...
    public class TrackTest {
        ...
        public void ParseYoutubeUrlTest() {
            //Prepare
            string testTrackUrl = @"http://quir.li/player.html?media=http%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3D0VqTwnAuHws&title=What%20makes%20you%20beautiful&artist=The%20piano%20guys%20covering%20One%20Republic&album=Youtube&6.49=Intro&30.12=Knocking%20part&46.02=Real%20playing&51.5=Piano%20forte&93.32=Stringified&123.35=Vocals&139.38=Key%20cover%20jam&150.16=Good%20morning%20sky&173.96=Final%20chord";
            //Act
            Track testTrack = new Track(testTrackUrl);
            ...
            Cue firstCue = testTrack.Cues.First();
        ...
        public void CreateForMp3Test() {
            //Prepare
            Cue cue1 = new Cue(0, "Intro");
            Cue cue2 = new Cue(15, "Verse 1");
            Cue cue3 = new Cue(45.5, "Verse 2");
            Cue cue4 = new Cue(75.94, "Chorus");
            Cue cue5 = new Cue(106.75, "Verse 3");
            Cue cue6 = new Cue(140.75, "Chorus");
            Cue cue7 = new Cue(172.07, "Bridge");
            Cue cue8 = new Cue(201.65, "Chorus");
            Cue cue9 = new Cue(232.65, "Outro");
