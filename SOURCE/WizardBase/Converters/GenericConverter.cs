...
namespace WizardBase {
    internal class GenericConverter<T> : TypeConverter {
        ...
        ///     An array of type <see cref="T:System.Attribute"></see> that is used as a filter.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="value">
        ///     The <see cref="T:System.Object"></see> to convert.
        /// </param>
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value) {
            ...
            if (constructor != null) {
                for (int i = 0; i < properties.Length; i++) {
                    ...
                    string s = TypeDescriptor.GetConverter(properties[i].PropertyType)
                                             .ConvertToString(context, culture, properties[i].GetValue(instance, null));
                    ...
                    if (TypeDescriptor.GetConverter(properties[i].PropertyType).CanConvertFrom(typeof(string))) {
                        object val =
                            TypeDescriptor.GetConverter(properties[i].PropertyType)
                                          .ConvertFromString(parts.Length == 2
                                                                 ? parts[1].Trim(new[] { '[', ']' })
                                                                 : string.Empty);
        ...
        ///     An <see cref="T:System.Collections.IDictionary"></see> of new property values.
        /// </param>
        /// <param name="context">
        ///     An <see cref="T:System.ComponentModel.ITypeDescriptorContext"></see> that provides a format context.
        /// </param>
                    ...
                    for (int i = 0; i < properties.Length; i++) {
                        if (properties[i].CanWrite) {
                            textArray[i] = properties[i].Name + "=[" +
                                           TypeDescriptor.GetConverter(properties[i].PropertyType)
                                                         .ConvertToString(context, culture,
                                                                          properties[i].GetValue(value, null)) + "]";
                        }
                    }
